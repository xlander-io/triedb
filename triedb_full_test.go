...
type Expect struct {
	...
	node_bytes doCheck
	node_hash  doCheck
	//node_hash_recoverable bool

	val                  []byte
	val_hash             doCheck
	val_hash_recoverable bool
	val_dirty            bool

	prefix_child_nodes                  doCheck
	prefix_child_nodes_hash             doCheck
	prefix_child_nodes_hash_recoverable bool

	folder_child_nodes                  doCheck
	folder_child_nodes_hash             doCheck
	folder_child_nodes_hash_recoverable bool
...
func (ex Expect) makeTests(o *Node) []TEST {
	tests := []TEST{
		...
		{"val_hash_recoverable", ex.val_hash_recoverable, o.val_hash_recoverable, ex.val_hash_recoverable == o.val_hash_recoverable},
		{"prefix_child_nodes_hash_recoverable", ex.prefix_child_nodes_hash_recoverable, o.prefix_child_nodes_hash_recoverable, ex.prefix_child_nodes_hash_recoverable == o.prefix_child_nodes_hash_recoverable},
		{"folder_child_nodes_hash_recoverable", ex.folder_child_nodes_hash_recoverable, o.folder_child_nodes_hash_recoverable, ex.folder_child_nodes_hash_recoverable == o.folder_child_nodes_hash_recoverable},
	}
...
func (n *Node) genCheckStatements(b io.Writer) {
	...
	funcMaps := template.FuncMap{
		...
		"Boolean": func(n *Node, field string) string {
			...
			} else if bytes.Equal([]byte("val_hash_recoverable"), string2Bytes(field)) {
				if false != n.val_hash_recoverable {
					return "true"
				}
			...
			} else if bytes.Equal([]byte("prefix_child_nodes_hash_recoverable"), string2Bytes(field)) {
				if false != n.prefix_child_nodes_hash_recoverable {
					return "true"
				}
			} else if bytes.Equal([]byte("folder_child_nodes_hash_recoverable"), string2Bytes(field)) {
				if false != n.folder_child_nodes_hash_recoverable {
					return "true"
				}
...
_{{Name .}}Tests := Expect{
	...
	val_hash_recoverable: {{Boolean . "val_hash_recoverable"}},
	...
	prefix_child_nodes_hash_recoverable: {{Boolean . "prefix_child_nodes_hash_recoverable"}},

	folder_child_nodes:                {{isNotNil . "folder_child_nodes"}},
	folder_child_nodes_hash:           {{isNotNil . "folder_child_nodes_hash"}},
	folder_child_nodes_hash_recoverable: {{Boolean . "folder_child_nodes_hash_recoverable"}},
